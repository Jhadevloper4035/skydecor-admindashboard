...
const CisrEventDetail = () => {
  ...
  return (
    <>
      ...
      <PageBreadcrumb title="CISR Event Detail" subName="CISR Events" />
        ...
        <Col md={4}>
          <Card className="shadow-none border">
            ...
            <div className="border-top p-3 d-flex gap-2 flex-wrap">
              <Link to={`/cisr-events/${eventId}/edit`} className="btn btn-primary flex-fill">
                <IconifyIcon icon="bx:edit" className="me-1" />Edit
              </Link>
              <Link to="/cisr-events" className="btn btn-outline-secondary flex-fill">
        ...
        <Col md={8}>
          <Card className="shadow-none border mb-3">
            <CardBody>
              ...
              <Row>
                <Col md={6}><Field label="CISR Event ID" value={event.id} /></Col>
...
export default CisrEventDetail;
